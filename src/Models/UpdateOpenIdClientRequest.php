 ...
 */
class UpdateOpenIdClientRequest implements JsonSerializable
{
    /**
     ...
     * @required
     * @maps RedirectUris
     * @var array $redirectUris public property
     */
    public $redirectUris;
     ...
     * @param array   $identityProviderRestrictions     Initialization value for $this->identityProviderRestrictions
    ...
    public function __construct()
    {
        if (27 == func_num_args()) {
            ...
            $this->redirectUris                     = func_get_arg(3);
            $this->enabled                          = func_get_arg(4);
            $this->clientUri                        = func_get_arg(5);
            $this->requireConsent                   = func_get_arg(6);
            $this->allowRememberConsent             = func_get_arg(7);
            $this->flow                             = func_get_arg(8);
            $this->allowClientCredentialsOnly       = func_get_arg(9);
            $this->postLogoutRedirectUris           = func_get_arg(10);
            $this->logoutUri                        = func_get_arg(11);
            $this->requireSignOutPrompt             = func_get_arg(12);
            $this->allowedScopes                    = func_get_arg(13);
            $this->identityProviderRestrictions     = func_get_arg(14);
            $this->identityTokenLifetime            = func_get_arg(15);
            $this->accessTokenLifetime              = func_get_arg(16);
            $this->absoluteRefreshTokenLifetime     = func_get_arg(17);
            $this->slidingRefreshTokenLifetime      = func_get_arg(18);
            $this->refreshTokenUsage                = func_get_arg(19);
            $this->updateAccessTokenClaimsOnRefresh = func_get_arg(20);
            $this->refreshTokenExpiration           = func_get_arg(21);
            $this->accessTokenType                  = func_get_arg(22);
            $this->includeJwtId                     = func_get_arg(23);
            $this->alwaysSendClientClaims           = func_get_arg(24);
            $this->allowedCorsOrigins               = func_get_arg(25);
            $this->allowAccessTokensViaBrowser      = func_get_arg(26);
        }
    }
