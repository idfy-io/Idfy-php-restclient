 ...
 */
class PdfTemplate implements JsonSerializable
{
    /**
     ...
     *                                                                        >addListOfSignaturesOnLastPageOfExistingPD
     *                                                                        F
     ...
     *                                                                        >includeLogo
     * @param \DateTime         $lastEdited                                 Initialization value for $this-
     *                                                                        >lastEdited
     */
    public function __construct()
    {
        if (10 == func_num_args()) {
            ...
            $this->coverPageSetting                           = func_get_arg(2);
            $this->addListOfSignaturesOnLastPageOfExistingPDF = func_get_arg(3);
            $this->coverPageHtml                              = func_get_arg(4);
            $this->detailsPageHtml                            = func_get_arg(5);
            $this->verifiedTemplate                           = func_get_arg(6);
            $this->labels                                     = func_get_arg(7);
            $this->includeLogo                                = func_get_arg(8);
            $this->lastEdited                                 = func_get_arg(9);
        }
    }
