 ...
 */
class CreateOpenIdClientRequest implements JsonSerializable
{
    /**
    ...
    public function __construct()
    {
        if (25 == func_num_args()) {
            ...
            $this->redirectUris                     = func_get_arg(2);
            $this->clientUri                        = func_get_arg(3);
            $this->requireConsent                   = func_get_arg(4);
            $this->allowRememberConsent             = func_get_arg(5);
            $this->flow                             = func_get_arg(6);
            $this->allowClientCredentialsOnly       = func_get_arg(7);
            $this->postLogoutRedirectUris           = func_get_arg(8);
            $this->logoutUri                        = func_get_arg(9);
            $this->requireSignOutPrompt             = func_get_arg(10);
            $this->allowedScopes                    = func_get_arg(11);
            $this->identityProviderRestrictions     = func_get_arg(12);
            $this->identityTokenLifetime            = func_get_arg(13);
            $this->accessTokenLifetime              = func_get_arg(14);
            $this->absoluteRefreshTokenLifetime     = func_get_arg(15);
            $this->slidingRefreshTokenLifetime      = func_get_arg(16);
            $this->refreshTokenUsage                = func_get_arg(17);
            $this->updateAccessTokenClaimsOnRefresh = func_get_arg(18);
            $this->refreshTokenExpiration           = func_get_arg(19);
            $this->accessTokenType                  = func_get_arg(20);
            $this->includeJwtId                     = func_get_arg(21);
            $this->alwaysSendClientClaims           = func_get_arg(22);
            $this->allowedCorsOrigins               = func_get_arg(23);
            $this->allowAccessTokensViaBrowser      = func_get_arg(24);
        }
    }
