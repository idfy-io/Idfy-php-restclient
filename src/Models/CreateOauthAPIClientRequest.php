 ...
 */
class CreateOauthAPIClientRequest implements JsonSerializable
{
    /**
    ...
    public function __construct()
    {
        if (14 == func_num_args()) {
            ...
            $this->clientSecrets                    = func_get_arg(2);
            $this->allowedScopes                    = func_get_arg(3);
            $this->identityTokenLifetime            = func_get_arg(4);
            $this->accessTokenLifetime              = func_get_arg(5);
            $this->absoluteRefreshTokenLifetime     = func_get_arg(6);
            $this->slidingRefreshTokenLifetime      = func_get_arg(7);
            $this->refreshTokenUsage                = func_get_arg(8);
            $this->updateAccessTokenClaimsOnRefresh = func_get_arg(9);
            $this->refreshTokenExpiration           = func_get_arg(10);
            $this->accessTokenType                  = func_get_arg(11);
            $this->alwaysSendClientClaims           = func_get_arg(12);
            $this->allowedCorsOrigins               = func_get_arg(13);
        }
    }
