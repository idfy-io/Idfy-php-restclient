...
{
    /**
     * @var NotificationsController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return NotificationsController The *Singleton* instance.
     */
    ...
    public function notificationsList(
        ...
        $_queryBuilder = $_queryBuilder.'/signature/documents/{documentId}/notifications';
        ...
        return $mapper->mapClassArray($response->body, 'IdfyLib\\Models\\NotificationLogItem');
    }
}
