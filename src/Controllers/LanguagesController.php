...
{
    /**
     * @var LanguagesController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return LanguagesController The *Singleton* instance.
     */
    ...
    public function retrieveLanguage(
        ...
        $_queryBuilder = $_queryBuilder.'/text/languages/{id}';
        ...
        return $mapper->mapClass($response->body, 'IdfyLib\\Models\\LanguageDTO');
    }
    ...
    public function listAllLanguages()
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/text/languages';
